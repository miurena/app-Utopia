(:~
    ...
    ODD: /db/apps/Github/resources/odd/Utopia.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/pm/models/Utopia/print";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(app) return
                        html:section($config, ., ("tei-app", css:map-rend-to-class(.)), .)
